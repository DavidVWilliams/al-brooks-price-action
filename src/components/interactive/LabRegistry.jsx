// Version: v1.3 - Added Tier 4.1 MTRStructureMapper Dynamic Routing
...
export function getInteractiveLab(moduleId) {
  ...
  // Tier 0
  if (id === 'tier0-mod-0.1' || id === '0.1' || id === 'tier0-0.1') return DOMOrderBookSimulator;
  if (id === 'tier0-mod-0.2' || id === '0.2' || id === 'tier0-0.2') return DualEngineArchitectureDiagram;
  ...
  // Tier 4
  if (id === 'tier4-mod-4.1' || id === '4.1' || id.toLowerCase().includes('mtr')) return MTRStructureMapper;
